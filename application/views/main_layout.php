    ...
    <body class="hold-transition skin-blue-light sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-mini">
                        ระบบรับชำระค่าใช้จ่าย<br>ผู้เช่าภายในหอพัก
                    </span>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"><?= isset($_SESSION['name']) ? $_SESSION['name'] : '' ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="<?= base_url('auth/logout') ?>" class="btn btn-default btn-flat">ออกจากระบบ</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
            ...
            <footer class="main-footer ">
                ...
                <strong> ระบบรับชำระค่าใช้จ่ายผู้เช่า ภายในหอพัก </strong> 
            </footer>
