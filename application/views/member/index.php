            ...
            <form action="<?= base_url() ?>member/delete" method="POST">
                <div class="box">
                    <div class="box-header">
                        <div class="col-md-12">
                            <a href="<?=  base_url('member/add')?>" class="btn btn-success btn-flat" name="btn_submit" value="เพิ่มข้อมูล">เพิ่มข้อมูล</a>
                                    ...
                                    <?php if (isset($resultq1)) { ?>
                                        <?php foreach ($resultq1 as $rows) { ?>
                                            <tr>
                                                ...
                                                <td class="">
                                                    <a href="<?= base_url() ?>member/edit/<?= $rows['id'] ?>" class="btn btn-sm btn-primary">แก้ไข / ดู</a>
                                            
                                                    <a href="#" onclick="if (confirm('คุณต้องการลบข้อมูลนี้หรือใม่?') == true) {
                                                document.location.href = '<?= base_url() ?>member/delete/<?= $rows['id'] ?>'
